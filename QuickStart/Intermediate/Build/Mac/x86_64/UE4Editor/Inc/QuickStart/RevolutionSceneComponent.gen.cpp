...
#include "QuickStart/5/RevolutionSceneComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	QUICKSTART_API UClass* Z_Construct_UClass_URevolutionSceneComponent_NoRegister();
	QUICKSTART_API UClass* Z_Construct_UClass_URevolutionSceneComponent();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URevolutionSceneComponent_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "5/RevolutionSceneComponent.h" },
		{ "ModuleRelativePath", "5/RevolutionSceneComponent.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(URevolutionSceneComponent, 2992292345);
	template<> QUICKSTART_API UClass* StaticClass<URevolutionSceneComponent>()
	{
		return URevolutionSceneComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_URevolutionSceneComponent(Z_Construct_UClass_URevolutionSceneComponent, &URevolutionSceneComponent::StaticClass, TEXT("/Script/QuickStart"), TEXT("URevolutionSceneComponent"), false, nullptr, nullptr, nullptr);
