...
// Cross Module References
	QUICKSTART_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
	QUICKSTART_API UClass* Z_Construct_UClass_AMyPawn();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMyPawn_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "4/MyPawn.h" },
		{ "ModuleRelativePath", "4/MyPawn.h" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyPawn, 140627816);
	template<> QUICKSTART_API UClass* StaticClass<AMyPawn>()
	{
		return AMyPawn::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyPawn(Z_Construct_UClass_AMyPawn, &AMyPawn::StaticClass, TEXT("/Script/QuickStart"), TEXT("AMyPawn"), false, nullptr, nullptr, nullptr);
