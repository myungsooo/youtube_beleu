...
#include "QuickStart/5/CollidingPawnMovementComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	QUICKSTART_API UClass* Z_Construct_UClass_UCollidingPawnMovementComponent_NoRegister();
	QUICKSTART_API UClass* Z_Construct_UClass_UCollidingPawnMovementComponent();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCollidingPawnMovementComponent_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "5/CollidingPawnMovementComponent.h" },
		{ "ModuleRelativePath", "5/CollidingPawnMovementComponent.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UCollidingPawnMovementComponent, 890364749);
	template<> QUICKSTART_API UClass* StaticClass<UCollidingPawnMovementComponent>()
	{
		return UCollidingPawnMovementComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UCollidingPawnMovementComponent(Z_Construct_UClass_UCollidingPawnMovementComponent, &UCollidingPawnMovementComponent::StaticClass, TEXT("/Script/QuickStart"), TEXT("UCollidingPawnMovementComponent"), false, nullptr, nullptr, nullptr);
